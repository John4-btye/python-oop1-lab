...
This project implements two Python classes, Book and Coffee, to model basic objects in a bookstore environment. Each class includes attributes, validation through properties, and methods that simulate real-world interactions.

# Features Implemented

The book class represents a readable book.

Attributes:

- title: The title of the book (string).
- page_count: The total number of pages in the book (must be an integer)

Functionality:

- Input validation ensures page_count is an integer.
  - if invalid, prints: page_count must be an integer.
- turn_page() method
  - Simulates reading by printing:
    Flipping the page...wow, you read fast!

# Coffee Class

The coffee class represents a coffee item available in the bookstore.
...
- Created Book class with validated page_count property and turn_page() method
- Created Coffee class with validated size property and tip() method
- Implemented strict validation and exact output formatting to pass automated tests
- Ensured all attributes and methods behave according to requirements
